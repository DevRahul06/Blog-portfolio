...
import { addSoftware, clearAllSoftwareErrors, getAllSoftware, resetSoftwareSlice } from "@/store/slices/softwareSlice";
  ...
  return (
    <>
      <div className="flex justify-center items-center min-h-[80vh] sm:gap-4 sm:py-4 sm:pl-14">
        <form className="w-[100%] px-5 md:w-[950px]" onSubmit={handleAddSoftware}>
          <div className="space-y-12">
            <div className="mt-10 grid  gap-x-6 gap-y-8 sm:grid-cols-6">
              <div className="col-span-full">
                <label className="block text-sm font-medium leading-6 text-gray-900">
                  Software Appliction  name
                </label>
                <div className="mt-2">
                  <Input
                    value={name}
